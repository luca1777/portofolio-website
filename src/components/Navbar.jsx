...
export const Navbar = () => {
  ...
  return (
    <div className="fixed bg-[#FFFFFF] w-full h-[80px] flex justify-between items-center px-4 text-[#2D2E32]">
      <div>
        <h3 className="text-[#2D2E32] text-xl font-bold mx-[1em]">Luca.dev</h3>
      </div>
      {/* menu */}
      ...
      {/* hamburger */}
      <div onClick={handleClick} className="md:hidden z-10 cursor-pointer text-[#2D2E32] hover:text-blue-500 text-xl">
        {!nav ? <FaBars /> : <FaTimes />}
      </div>
      {/* mobile menu */}
